...
from sqlalchemy import String, Column, BIGINT, UnicodeText
...
class FloodControl(BASE):
    ...
    count = Column(BIGINT, default=DEF_COUNT)
    limit = Column(BIGINT, default=DEF_LIMIT)
...
class FloodSettings(BASE):
    ...
    chat_id = Column(String(14), primary_key=True)
    flood_type = Column(BIGINT, default=1)
